...
// import { ICartViewProps as , ICartlinesViewProps } from '../definition-extensions/cart.ext.props.autogenerated';
        ...
        return (cartDataResult ?
            (
                <div className='msc-cart__empty-cart'>
                    <p className='msc-cart-line'>{cartEmptyText} So go back to shopping</p>
